...
<body>
    ...
    <div class="container">
        <div class="breadcrumb">
            ...
            <a href="#">Persuasão</a>
            <span>/</span>
            <span>As Armas da Persuasão</span>
        </div>
    </div>
        ...
        <div class="container">
                ...
                <div class="product-gallery">
                    <div class="thumbnail-list">
                        <div class="thumbnail active" onclick="changeImage('As-Armas-da-Persuas_o.jpg')">
                            <img src="As-Armas-da-Persuas_o.jpg" alt="Capa do Livro">
                        </div>
                    ...
                    <div class="main-image">
                        <img src="As-Armas-da-Persuas_o.jpg" alt="As Armas da Persuasão" id="mainProductImage">
                    </div>
                </div>
                
                <!-- Informações do Produto -->
                <div class="product-info">
                    <h1 class="product-title">As Armas da Persuasão</h1>
                    ...
                    <div class="product-meta">
                        ...
                        <i class="fas fa-star"></i>
                            ...
                            <span class="product-review-count">(96 avaliações)</span>
                        </div>
                        <span class="product-brand">Por Robert B. Cialdini</span>
                    </div>
                    ...
                    <div class="product-description">
                        <p>A persuasão é um processo pelo qual uma pessoa convence outra de alguma coisa, ou seja, é a arte de influenciar uma pessoa a dizer sim a um pedido. Então, as armas da persuasão nada mais são do que técnicas e estratégias para acionar gatilhos mentais.</p>
                    </div>
            ...
            <div class="product-tabs">
                ...
                <div id="description" class="tab-content active">
                    ...
                    <p>"Depois de passar anos caindo na lábia de vendedores, arrecadadores de doações e operadores de telemarketing, o psicólogo Robert B. Cialdini resolveu se dedicar ao estudo da persuasão. Ele queria entender quais são os fatores que levam uma pessoa a dizer "sim" a um pedido e que técnicas exploram melhor esses fatores.<br></br>

Reunindo dados das mais recentes pesquisas científicas sobre o assunto, his­tórias de gente comum e a experiência adquirida ao se infiltrar em organizações que treinam os chamados "profissionais da persuasão", Cialdini criou uma obra acessível, informativa e indispensável a todos aqueles que querem saber como influenciar pessoas e, ao mesmo tempo, se defender dos manipuladores.</p>
                    
                    <p>O livro aborda:</p>
                    <ul>
                        <li>Reciprocidade</li>
                        <li>Compromisso e Coerência</li>
                        <li>Prova Social (Aprovação Social)</li>
                        <li>Autoridade</li>
                        <li>Afinidade (Gosto pessoal)</li>
                        <li>Escassez</li>
                    </ul>
                ...
                <div id="details" class="tab-content">
                    ...
                    <ul>
                        <li><strong>Autor:</strong>Robert B. Cialdini</li>
                        <li><strong>Editora:</strong>HarperCollins Brasil</li>
                        <li><strong>Idioma:</strong> Português</li>
                        <li><strong>Encadernação:</strong> Brochura</li>
                        <li><strong>Número de páginas:</strong> 224</li>
                        <li><strong>ISBN-10:</strong> não usualmente usado no Brasil; o equivalente numérico de 10 dígitos não foi disponibilizado diretamente, mas o mercado brasileiro atual</li>
                        <li><strong>ISBN-13:</strong> 978‑6555111811</li>
                        <li><strong>Dimensões:</strong> 15,5 × 23,0 cm</li>
                        <li><strong>Peso:</strong> 825g</li>
                        <li><strong>Data de publicação:</strong>agosto de 2021 (1ª edição 2.0 em português lançada em 15 de agosto)</li>
                    </ul>
                </div>
    ...
    <script src="JavaScript/Produto 2.js" defer></script>
</body>
</html>