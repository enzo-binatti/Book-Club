...
<body>
        ...
        <div class="container">
            <div class="product-container">
                ...
                <div class="product-gallery">
                    <div class="thumbnail-list">
                        <div class="thumbnail active" onclick="changeImage('a arte da guerra.webp')">
                            <img src="a arte da guerra.webp" alt="Capa do Livro">
                        </div>
                    ...
                    <div class="main-image">
                        <img src="a arte da guerra.webp" alt="A Arte Da Guerra" id="mainProductImage">
                    </div>
                </div>
                
                <!-- Informações do Produto -->
                <div class="product-info">
                    <h1 class="product-title">A Arte Da Guerra</h1>
                    ...
                    <div class="product-meta">
                        ...
                        <i class="fas fa-star"></i>
                            ...
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <span class="product-review-count">(378 avaliações)</span>
                        </div>
                        <span class="product-brand">Por sun Tzu</span>
                    </div>
                    ...
                    <div class="product-description">
                        <p>A Arte da Guerra é um livro escrito por Sun Tzu, um general chinês que viveu entre o século VII e o século V a.C. O livro é considerado um dos mais influentes e bem-sucedidos livros de estratégia e estratégia de negócios.</p>
                    </div>
            ...
            <div class="product-tabs">
                ...
                <div id="details" class="tab-content">
                    ...
                    <ul>
                        <li><strong>Autor:</strong> Sun Tzu</li>
                        <li><strong>Editora:</strong> Pandorga Editora</li>
                        <li><strong>Idioma:</strong> Português</li>
                        <li><strong>Encadernação:</strong> Brochura</li>
                        <li><strong>Número de páginas:</strong> 96</li>
                        <li><strong>ISBN-10:</strong> 8561784040</li>
                        <li><strong>ISBN-13:</strong> 978‑8561784041</li>
                        <li><strong>Dimensões:</strong> 15,6cm x 10,2cm x 1cm</li>
                        <li><strong>Peso:</strong> 150g</li>
                        <li><strong>Data de publicação:</strong> 1 de janeiro de 2011</li>
                    </ul>
                </div>
    ...
    <script src="JavaScript/produto 5.js"></script>
</body>
</html>