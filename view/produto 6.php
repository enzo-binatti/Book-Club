...
<body>
        ...
        <div class="container">
            <div class="product-container">
                ...
                <div class="product-gallery">
                    <div class="thumbnail-list">
                        <div class="thumbnail active" onclick="changeImage('o poder do habito.jpg')">
                            <img src="o poder do habito.jpg" alt="Capa do Livro">
                        </div>
                    ...
                    <div class="main-image">
                        <img src="o poder do habito.jpg" alt="O Poder do Hábito" id="mainProductImage">
                    </div>
                </div>
                
                <!-- Informações do Produto -->
                <div class="product-info">
                    <h1 class="product-title">O Poder do Hábito</h1>
                    ...
                    <div class="product-meta">
                        ...
                        <i class="fas fa-star"></i>
                            ...
                            <span class="product-review-count">(187 avaliações)</span>
                        </div>
                    ...
                    <div class="product-description">
                        <p>"O Poder do Hábito" é um livro que explica como os hábitos funcionam e como podemos usá-los para nos beneficiar.</p>
                    </div>
                    ...
                    <div class="product-delivery">
                        ...
                        <div class="delivery-option">
                            ...
                            <div class="delivery-text">
                                ...
                                <span>Disponível em 4 horas</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="product-tabs">
                ...
                <div id="description" class="tab-content active">
                    ...
                    <p>O livro aborda:</p>
                    <ul>
                        <li>Explica como os hábitos funcionam</li>
                        <li>Mostra como criar hábitos positivos</li>
                        <li>Mostra como quebrar hábitos negativos</li>
                        <li>Mostra como usar hábitos para alcançar metas</li>
                    </ul>
                ...
                <div id="details" class="tab-content">
                    ...
                    <ul>
                        ...
                        <li><strong>Peso:</strong> 619g a 658g</li>
                        <li><strong>Data de publicação:</strong> 24 de setembro de 2012</li>
                    </ul>
                </div>
    ...
    <script src="JavaScript/produto 6.js"></script>
</body>
</html>